      ...
      <div className="container mx-auto px-4 py-12 sm:py-16 max-w-4xl">
        <Card>
          ...
          <CardContent className="prose prose-sm max-w-none dark:prose-invert">
            ...
            <h2>Contact</h2>
            <p>
              Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please call or email us at <a href="mailto:support@monetizedprofiles.com">support@monetizedprofiles.com</a>.
            </p>
          </CardContent>
        </Card>
      </div>
