    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative pt-24 pb-32 md:pt-32 md:pb-40 overflow-hidden bg-background">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-5xl mx-auto text-center relative">
            ...
            <div className="absolute -right-24 top-16 hidden lg:block animate-float" style={{ animationDelay: '1s' }}>
            ...
            <div className="absolute -right-20 bottom-12 hidden lg:block animate-float" style={{ animationDelay: '1.5s' }}>
              <Star className="w-11 h-11 text-[#FF2929]" style={{ filter: 'drop-shadow(0 0 20px rgba(255, 41, 41, 0.6))' }} />
            </div>
            <div className="absolute left-1/2 -translate-x-1/2 -top-12 hidden lg:block animate-float" style={{ animationDelay: '0.75s' }}>
              <Percent className="w-10 h-10 text-[#C74DFF]" style={{ filter: 'drop-shadow(0 0 20px rgba(199, 77, 255, 0.6))' }} />
            </div>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="relative overflow-hidden w-screen max-w-none mx-[calc(50%-50vw)]">
