          ...
          <div className="max-w-7xl mx-auto relative">
            ...
            {canScrollLeft && (
              <Button
                variant="outline"
                size="icon"
                className="hidden sm:flex absolute -left-2 lg:-left-3 top-1/2 -translate-y-1/2 z-10 bg-[#FF2929] hover:bg-[#FF2929]/90 text-white border-[#FF2929] shadow-lg touch-manipulation"
                onClick={() => scroll('left')}
              >
            ...
            {canScrollRight && (
              <Button
                variant="outline"
                size="icon"
                className="hidden sm:flex absolute -right-2 lg:-right-3 top-1/2 -translate-y-1/2 z-10 bg-[#FF2929] hover:bg-[#FF2929]/90 text-white border-[#FF2929] shadow-lg touch-manipulation"
